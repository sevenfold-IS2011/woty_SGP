...
Scopo di questa sezione è il descrivere l'architettura generale di Woty.
...
Per il diagramma ad oggetti a figura \ref{S-do}, è stata utilizzata la notazione Crow's Foot per descrivere le relazioni tra le entità.
