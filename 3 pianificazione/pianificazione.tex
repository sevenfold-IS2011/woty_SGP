...
\hline
\rule[-2mm]{0mm}{0.7cm}
Esperto gamification & 104 (26 giorni) &  \EUR \ 2600 \\
\hline
\rule[-2mm]{0mm}{0.7cm}
...
\hline
\rule[-2mm]{0mm}{0.7cm}
Analisi e pianificazione iniziale & \EUR \ 1000 \\
\hline
\rule[-2mm]{0mm}{0.7cm}
Analisi di mercato & \EUR \ 3040 \\
\hline
\rule[-2mm]{0mm}{0.7cm}
Studio di fattibilità & \EUR \ 2580 \\
\hline
\rule[-2mm]{0mm}{0.7cm}
Progettazione business model & \EUR \ 5785 \\
\hline
\rule[-2mm]{0mm}{0.7cm}
Stima rischi/Stima costi & \EUR \ 2250 \\
\hline
\rule[-2mm]{0mm}{0.7cm}
\textbf{Totale} & \textbf{\EUR \ 14655} \\
\hline
\end{longtable}
