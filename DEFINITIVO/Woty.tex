...
Per poter rilasciare questi attestati, tutti i materiali del nostro corso devono essere redatti da un esperto di sicurezza certificato (si veda la sezione analisi dei costi \red{fare ref lory cap6}).\\
...
\begin{itemize}
	\item \textbf{Manutenzione acquisto o la locazione del server:} \red{(...)}
\end{itemize}
