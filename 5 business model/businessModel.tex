...
\subsection{Formula pay-per-user}
Come conseguenza naturale della natura dei costi deriva la formula di pagamento pay-per-user: il cliente paga quello che utilizza. 
La fatturazione del cliente quindi è legata al numero di utenti che iscrive e le commesse.

\subsection{Business Model}
In figura il canvas construito per Woty. 
