...
\item \textbf{Sistemi di pagamento digitale}: Il pagamento delle sottoscrizioni dei clienti avviene in maniera automatica tramite i carta di credito, paypal. 	
...
\item \textbf{Costi variabili}: sono quelli legati alla parte di pubblicità, alle inserzioni e quelli legati alle partnership che eseguono lavori su commissione. Esistono inoltre costi variabili legati al numero di utenti dell'applicazione. E' infatti previsto un sistema di autoscaling che aumenta e diminuisce il numero di macchine adibite all'erogazione del servizio a seconda del carico corrente. Le macchine ovviamente hanno anche un costo legato all'utenza.
...
\item l'applicazione entra nella vita lavorativa dei dipendenti delle aziende: è plausibile pensare che un amministratore abbia necessità di controllare l'uso che i dipendenti fanno del software. Si è ideato quindi lo sviluppo di un pannello adibito a pagamento che possa fornire il servizio entro i termini di legge.\\
\underline{tempistiche}: 3 settimane per due programmatori;\\
\underline{costo stimato}: 3000\EUR.
